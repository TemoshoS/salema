...
const sendShakeDetectedSms = async (location) => {
  try {
    ...
    const message = `Hi it's Temosho Shaku ,I'm in danger I need help. My location: https://www.google.com/maps?q=${location.coords.latitude},${location.coords.longitude}`;
