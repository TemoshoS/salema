  ...
  return new Promise((resolve, reject) => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        const currentUserName = user.displayName || 'No display name'; // Use displayName instead of name
        console.log('User is signed in:', currentUser);
        console.log('User name:', currentUserName);
        resolve({ uid: currentUser, name: currentUserName });
      } else {
...
export const sendShakeDetectedSms = async (location) => {
  try {
    ...
    const message = `Hi, it's ${currentUser.displayName}. I'm in danger and need help. My location: https://www.google.com/maps?q=${location.coords.latitude},${location.coords.longitude}`;
