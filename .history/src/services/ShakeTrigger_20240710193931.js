...
const sendShakeDetectedSms = async (location) => {
  try {
    ...
    const message = `Hi, it's ${currentUser.display}. I'm in danger and need help. My location: https://www.google.com/maps?q=${location.coords.latitude},${location.coords.longitude}`;
