...
const getCurrentUser = async () => {
  ...
  console.log('Current user:', currentUser); // Log the entire currentUser object for debugging
  const user = currentUser; 
  console.log('User name:', user ? user.name : 'User is undefined'); // Log user's name if available
  return user;
};
...
export { initializeAuthState,getCurrentUser,getContacts ,addContact, updateContact, removeContact,getPhoneNumbersForCurrentUser};
