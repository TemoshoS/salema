...
const sendShakeDetectedSms = async (location) => {
  try {
    ...
    console.log('Current User:', currentUser); // Debugging line to check currentUser structure
    if (!currentUser) {
      console.error('No current user found.');
      return;
    }

    const userName = currentUser.name || currentUser.username || 'User'; // Adjust this according to your user object
