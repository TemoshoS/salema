...
const MissingScreen = () => {
  ...
  const handleShare = async (names, lastSeen, age, imageUri, contacts) => {
    try {
      const fileUri = FileSystem.documentDirectory + `${names}.jpg`;
  
      await FileSystem.downloadAsync(imageUri, fileUri);
  
      await Sharing.shareAsync(fileUri, {
        mimeType: 'image/jpeg',
        dialogTitle: 'Share this missing person',
        UTI: 'image/jpeg',
        message: `Help find ${names}! Last seen: ${lastSeen}, Age: ${age}, Contacts: ${contacts}, Picture: ${imageUri}`,
      });
