...
import { View, Text, TextInput, StyleSheet, Image, Alert, Share, Modal, TouchableOpacity, FlatList } from 'react-native';
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalView}>
            ...
            <View style={styles.modalButtonContainer}>
              ...
              <TouchableOpacity style={styles.button} onPress={() => setAddPersonModalVisible(false)}>
