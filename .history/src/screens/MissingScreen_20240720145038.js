...
const MissingScreen = () => {
  ...
  const handleComment = (person) => {
    ...
    setComment('');
    setCommentModalVisible(true); // Set only comment modal visible
  };
  ...
  const handleAddComment = async () => {
    try {
      ...
      setCommentModalVisible(false); // Hide comment modal
      setComment('');
  ...
  const handleAddPerson = async () => {
    try {
      ...
      setAddPersonModalVisible(false); // Hide add person modal
      setNewPerson({ names: '', age: '', lastSeen: '', image: '' }); // Clear input fields
