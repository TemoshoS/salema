...
import { collectionaddDoc, updateDoc, deleteDoc, doc } from 'firebase/firestore';
...
const MissingScreen = () => {
  ...
  const handleAddMenuItem = async () => {
    try {
      ...
      const personCollection = collection(db, 'Menu');
      const imageRef = ref(storage, `menuImages/${newPerson.names}`);
