...
import { View, Text, TextInput, StyleSheet, Image, Button, Alert, Share, ScrollView, Modal, TouchableOpacity, FlatList } from 'react-native';
...
const MissingScreen = () => {
  ...
  const handleAddComment = async () => {
    try {
      ...
      setComment('');
      // Update missing persons list to reflect new comments
      ...
      {missingPersons.map((person) => (
        <View key={person.id} style={styles.card}>
          ...
          <View style={styles.buttonContainer}>
            <Button title="Comment" onPress={() => handleComment(person)} />
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalView}>
            ...
            <View style={styles.modalButtonContainer}>
              ...
              <Button title="Cancel" onPress={() => setSelectedPerson(null)} />
            </View>
          </View>
        </View>
      </Modal>
