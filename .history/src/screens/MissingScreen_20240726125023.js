...
const styles = StyleSheet.create({
  ...
  overlayText: {
    position: 'absolute',
    bottom: 10, // Adjust this value to change vertical position
    ...
    fontSize: 16,
    fontWeight: 'bold',
    transform: [{ rotate: '0deg' }], // Rotate text if needed
    textAlign: 'center', // Horizontal alignment of the text
    width: '80%', // Adjust width to control text wrapping
  },

  // Example: Center vertically and horizontally
  overlayText: {
    position: 'absolute',
    top: '50%',
    left: '50%',
    transform: [
      { translateX: -50% }, // Use percentage values correctly
      { translateY: -50% }, // Use percentage values correctly
    ],
    backgroundColor: 'rgba(0, 0, 0, 0.6)',
    color: '#ffffff',
    padding: 5,
  ...
  // Example: Rotate text 45 degrees
  overlayTextRotated: {
    position: 'absolute',
    bottom: 10,
    left: 10,
